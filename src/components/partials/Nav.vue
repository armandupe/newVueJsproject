<template>
  <nav class="navbar container" role="navigation" aria-label="main navigation">
    <div class="navbar-brand">
      <a
        target="_blank"
        class="navbar-item navbar-item__instagram-link"
        href="https://www.instagram.com/torveband/"
      >
        <img
          alt="logo"
        ...
        />
        <strong class="navbar-item__instagram is-size-4">torveband</strong>
      </a>
      <a
        role="button"
      ...
      <div class="burger-menu hide">
        <div class="burger-menu__links">
          <router-link to="/" class="navbar-item navbar-item_bx-shadow-hide"
            >Home</router-link
          >
          <router-link
            to="/listen"
            class="navbar-item navbar-item_bx-shadow-hide"
            >Listen</router-link
          >
          <router-link to="/band" class="navbar-item navbar-item_bx-shadow-hide"
            >Band</router-link
          >
          <router-link
            to="/contact"
      ...
      <svg class="main-logo" viewBox="0 0 8000 8000" height="100" width="100">
        <path
          ...
          style="
            ...
            stroke: none;
          "
          d="M 621.461,8090.51 H 311.176 v -0.88 H 0 V 7779.34 H 311.176 V 0 h 310.285 v 7779.34 h 311.172 v 310.29 H 621.461 v 0.88"
        />
        <path
          id="path16"
          style="
            ...
            stroke: none;
          "
          d="M 1711.46,311.172 H 1398.51 V 7779.34 h 312.95 z m 0,7778.458 h -312.95 v 0.88 H 1088.22 V 0 h 310.29 v 0.878906 h 312.95 V 0 h 310.28 V 0.878906 311.172 7779.34 v 310.29 0.88 h -310.28 v -0.88"
        />
        <path
          id="path18"
          style="
            ...
            stroke: none;
          "
          d="M 3889.67,620.352 3576.72,1089.1 V 8090.51 H 3266.44 V 933.52 L 3889.67,0 h 310.29 V 8090.51 H 3889.67 V 620.352"
        />
        <path
          id="path20"
          style="
            ...
            stroke: none;
          "
          d="m 2800.56,6534.64 h -312.94 v 1244.7 h 312.94 z m 0,1554.99 h -312.94 v 0.88 H 2177.33 V 0 h 310.29 v 6174.36 l 312.94,-728.83 V 0 h 310.29 v 5445.53 0.01 0 l -334.42,778.82 h 24.13 v -0.89 h 310.29 v 0.89 310.28 1244.7 310.29 0.88 h -310.29 v -0.88"
        />
        <path
          id="path22"
          style="
...
export default {
  ...
  mounted() {
    function changeBackgroundOnScroll() {
      const navMenuLogo = document.querySelector(".navbar-brand");
      const navMenu = document.querySelector(".navbar");
      if (window.scrollY > 0 && !navMenu.classList.contains("navbar-scroll-bg")) {
        navMenuLogo.classList.add("navbar-scroll-bg-brand");
        navMenu.classList.add("navbar-scroll-bg");
      } else if (window.scrollY == 0 && navMenu.classList.contains("navbar-scroll-bg")) {
        navMenuLogo.classList.remove("navbar-scroll-bg-brand");
        navMenu.classList.remove("navbar-scroll-bg");
      }   
    }
    window.addEventListener("scroll", changeBackgroundOnScroll, {passive: true});
  },
};
</script>
...
.navbar {
  ...
  &-item:not(.navbar-item__instagram-link):not(.navbar-item_bx-shadow-hide):hover {

    ...
    <div class="footer__container">
        <ul class="footer__list">
            <li class="footer__list-el" v-for="link in links" :key="link.id">
                ...
                <svg v-if="link.svg == 'vkicon'" width="56px" height="56px" viewBox="0 0 500 500">
                ...
                <svg v-if="link.svg == 'bandcampicon'" width="66px" height="56px" viewBox="0 0 450 400">
                <path style="fill: #fff;" d="M25.634,272.867c-6.45,0.104-11.945,2.751-15.96,8.562H9.461v-27.592H0.156v75.903h8.774v-6.873h0.21
                ...
                <path style="fill: #fff;" d="M97.409,320.117V288.3c0-14.161-16.068-15.434-20.506-15.434c-13.637,0-22.41,5.18-22.833,18.395h8.563
                ...
                <path style="fill: #fff;" d="M133.562,272.867c-9.514,0-14.695,6.448-16.701,9.404h-0.213v-7.819h-8.773v55.286h9.301V299.61
                ...
                <path style="fill: #fff;" d="M197.94,282.271h-0.21c-2.219-3.163-6.45-9.404-16.491-9.404c-14.692,0-23.043,12.053-23.043,27.592
                ...
                <path style="fill: #fff;" d="M240.539,281.219c7.824,0,11.948,4.438,13.106,11.837h8.988c-0.742-9.617-6.241-20.194-20.722-20.194
                    ...
                    z"/>
                <path style="fill: #fff;" d="M309.674,320.117V288.3c0-14.161-16.065-15.434-20.507-15.434c-13.637,0-22.409,5.18-22.834,18.395h8.563
                ...
                <path style="fill: #fff;" d="M377.433,272.867c-8.563,0-12.266,3.805-16.909,8.987c-1.59-2.961-4.759-8.987-14.695-8.987s-14.694,6.448-16.702,9.404
                ...
                <path style="fill: #fff;" d="M427.642,272.867c-10.037,0-14.262,6.241-16.488,9.404h-0.214v-7.819h-8.773v77.166h9.305v-27.694h0.212
                ...
                <polygon style="fill: #fff;" points="0,251.739 181.402,251.739 251.965,99.074 70.561,99.074 	"/>
                <path style="fill: #fff;" d="M301.692,136.215c-12.59,0.208-23.315,5.368-31.155,16.712h-0.417V99.072h-18.157V247.22h17.131v-13.412h0.41
                ...
                <path style="fill: #fff;" d="M407.408,152.517c15.268,0,23.324,8.664,25.589,23.106h17.534c-1.443-18.771-12.171-39.41-40.44-39.41
                ...
                <svg v-if="link.svg == 'youtubeicon'" width="56px" height="56px" viewBox="0 0 550 350">
